...
import com.dianping.wizard.widget.concurrent.WidgetTimeoutException;
            ...
            for (String widgetName : entry.getValue()) {
                ...
                if (tasks == null || tasks.get(widgetName) == null) {
                    ...
                    try {
                        ...
                        logger.error(msg, new WidgetRenderingException(msg, e));
                    } catch (ExecutionException e) {
                        String msg = "failed to retrieve result - widget:" + widget.name;
                        logger.error(msg, new WidgetRenderingException(msg, e));
                    } catch (TimeoutException e) {
                        String msg = "failed to retrieve result - widget:" + widget.name;
                        logger.error(msg, new WidgetTimeoutException("widget timeout:" + widget.name, e));
                    }
                }
